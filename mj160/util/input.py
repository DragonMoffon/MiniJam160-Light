...
def setup_input(manager: InputManager):
    ...
    manager.new_axis("player-motion_vertical")
    manager.add_axis_input("player-motion_vertical", Keys.W, 1.0)
    manager.add_axis_input("player-motion_vertical", Keys.S, -1.0)
    manager.add_axis_input("player-motion_vertical", ControllerAxes.LEFT_STICK_Y)
    manager.new_axis("player-motion_horizontal")
    manager.add_axis_input("player-motion_horizontal", Keys.A, -1.0)
    manager.add_axis_input("player-motion_horizontal", Keys.D, 1.0)
    manager.add_axis_input("player-motion_horizontal", ControllerAxes.LEFT_STICK_X)
